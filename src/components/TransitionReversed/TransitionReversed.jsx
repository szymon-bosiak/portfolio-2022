  ...
  return (
      <div>
          <svg className="waves_rev" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
              ...
              <g className="parallax_rev">
                  <use xlinkHref="#gentle_wave_rev" x="48" y="0" fill="rgba(255,255,255,0.7" />
                  <use xlinkHref="#gentle_wave_rev" x="48" y="3" fill="rgba(255,255,255,0.5)" />
                  <use xlinkHref="#gentle_wave_rev" x="48" y="5" fill="rgba(255,255,255,0.3)" />
                  <use xlinkHref="#gentle_wave_rev" x="48" y="7" fill="#fff" />
              </g>
          </svg>
      </div>
  )
